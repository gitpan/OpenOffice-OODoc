...
For example
	...
	my $styles = ooDocument(file => "source.sxw", member => "styles");

is generally better than

	my styles = ooStyles(file => "source.sxw");
...
=head3	Constructor : OpenOffice::OODoc::Document->new(<parameters>)
	...
	given, the member selected by default is "content".
