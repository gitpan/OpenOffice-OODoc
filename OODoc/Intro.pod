...
A one-file reference manual of the API is available in SXW format
(OpenOffice.org Writer document) of PDF. In can be downloaded from
the project homepage (http://www.genicorp.com/devel/oodoc).
