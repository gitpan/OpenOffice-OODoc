...
and replaced by the odfDocument() function.
...
and can operate on several documents in the same session. For example:
	...
	my $doc1 = odfXPath(file => 'file1.odt', member => 'content');
	my $doc2 = odfXPath(file => 'file2.odt', member => 'content');
...
syntax. Example:
	...
	# a program
	my $doc = odfXPath(file => 'file1.odt', member => 'content');
