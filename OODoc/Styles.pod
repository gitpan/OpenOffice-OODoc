...
=head3	createStyle(name, options)
        ...
        colour codes are in RGB hexadecimal preceded by a '#' [35].
	...
	and sometimes required for ODF, you can safely use it if you want
...
=head3	styleProperties(style [, options])
	...
	"area" option should be provides, because a style's properties may
