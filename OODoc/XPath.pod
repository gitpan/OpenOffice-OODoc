...
=head3	Constructor : OpenOffice::OODoc::XPath->new(<parameters>); [4] 
	...
	a character string, it's processed as a filename, but if this value,
	is an existing OpenOffice::OODoc::XPath, the new object is
	...
	not linked with each other) produce wrong (and sometimes unpredictable)
