...
amongst several manual pages on a thematic and technical basis.

For the newbie (I mean the OOo newbie, who is not necessarily a Perl
beginner !) , it's strongly recommended to have a look at the
OpenOffice::OODoc::Intro manual page, in order to get a quick and practical
...
with text, presentation and/or images.
