...
operations on files which comply with the OASIS OpenDocument Format (ODF),
i.e. the ISO/IEC 26300 standard.
...
features. This introduction, as well as the present chapter, should be
